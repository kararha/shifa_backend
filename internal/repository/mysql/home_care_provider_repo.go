...
// // List retrieves a list of home care providers with optional filtering and pagination
// func (r *HomeCareProviderRepo) List(ctx context.Context, filter models.HomeCareProviderFilter, offset, limit int) ([]*models.HomeCareProvider, error) {
// 	query := `
// 		SELECT user_id, service_type_id, experience_years, qualifications, bio, 
// 			profile_picture_url, hourly_rate, rating, is_verified, is_available, 
// 			status, latitude, longitude
